...
CREATE TABLE `carparking` (
  `CARPAKING_ID` varchar(255) NOT NULL,
  `AMOUNT` float DEFAULT NULL,
  `FREE` tinyint(1) DEFAULT '1',
  `PLANTNUMBER` varchar(255) DEFAULT NULL,
  `CUSTOMER_ID` varchar(255) DEFAULT NULL,
  `CARTYPE` varchar(255) DEFAULT NULL,
  `ACTIVATE` tinyint(1) DEFAULT '0',
  `CLOSE` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`CARPAKING_ID`),
  KEY `FKp4wxp581rcqdfwskga0nsygu` (`CUSTOMER_ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `carparking` VALUES ('1e5302bb-d8cc-43d9-9617-5e448069c4c5',NULL,1,'PP 2H-7818','66f162fa-9459-4c78-9179-e2a1bcd484fc','GS 300',0,0),('270f8ed3-c09e-4358-b22b-246c7472069b',35,0,'PP 2Z-0777','66f162fa-9459-4c78-9179-e2a1bcd484fc','Audi A7',1,0),('615c9762-8916-4bd7-a23b-33ba70881e4c',30,0,'PP 2AH-7818','66f162fa-9459-4c78-9179-e2a1bcd484fc','BMW 640i',1,0),('959d1d0d-1620-452d-ab8e-36790228c147',20,0,'PP 2AH-0777','66f162fa-9459-4c78-9179-e2a1bcd484fc','S-Class AMG 63',1,0),('73396480-ef7d-4dc2-be5c-84e01d30f7a6',40,0,'2AH PP-3333','575275b0-c304-440f-b613-561212f374f2','Ben',1,0);
...
CREATE TABLE `customer` (
  ...
  `CLOSE` tinyint(1) DEFAULT '0',
  `PARK_STATU` tinyint(1) DEFAULT '0',
  `IMAGE` mediumblob,
...
INSERT INTO `customer` VALUES ('110cd2ac-1dd5-4b25-b392-636c6882a37b','Phnom Penh, Cambodia','Lida','1993-01-31','Female','Developer','016556955','dd756f47-99bb-4e3d-ba98-0f99eab295c7',0,0,NULL),('b06442f8-866d-447d-b50e-10abd2a369a4','Phnom Penh, Cambodia.','Mark','1990-08-01','Male','Network','016345678','021f0f41-0724-4e5a-8acf-a08c8f9d6d49',0,0,NULL),('66f162fa-9459-4c78-9179-e2a1bcd484fc','J32, Jade, Phnom Penh, Cambodian.','Fong','1989-10-10','Male','Sale','097345678','d76d7fa6-3d1f-4c25-b1d9-9e2f4ccdfdd5',0,1,NULL),('d29c8808-5d29-490d-9ec1-fb8cdf75e11d','Phnom Penh, Cambodia;','Song','1997-12-12','Male','HR','096345678','a783edad-a421-445d-a422-d4c55d3dd5fe',0,0,NULL),('1ead89b6-4076-4ac9-a2b8-af5c161e70b2','Phnom Penh, Cambodia.','Pov','1989-09-08','Male','Programmer','016914915','8967c3bf-1a53-4ffa-a81a-4bdcab5df36e',0,0,NULL),('e25502c0-4437-4caf-8fb6-ccc63db4d225','Phnom Penh, Cambodia.','Hav','1989-09-09','Male','Business','012713113','8313832a-1c29-420e-8554-1f2c607f4449',0,0,NULL),('f63a7275-721e-41ef-9a0e-51315bca6184','Phnom Penh, Cambodia.','Yina','1994-12-12','Female','sale','097777742','2765bc1d-6c51-4f35-8b7f-2f4806957a93',0,0,NULL),('59960d5e-13aa-48b5-aebf-ca02ef3335ae','Phnom Penh, Cambodia.','Doms','1986-02-18','Male','Developer','096666616','e250ce1b-8538-46e7-960a-0d44284dddc4',0,0,NULL),('575275b0-c304-440f-b613-561212f374f2','Casa','Nik','1993-09-01','Male','Designer','016556955','dd756f47-99bb-4e3d-ba98-0f99eab295c7',0,1,NULL);
...
CREATE TABLE `history_payment` (
  ...
  `AMOUNT` float DEFAULT NULL,
  `CARTPYE` varchar(255) DEFAULT NULL,
  `CUSTOMER_NAME` varchar(255) DEFAULT NULL,
  `FLOOR_NUMBER` int(11) DEFAULT NULL,
  `INSTALLMENT_NUMBER` int(11) DEFAULT NULL,
  ...
  KEY `FKi8j6jbomkx62un4o6m94bl7fg` (`USER_ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `history_payment` WRITE;
/*!40000 ALTER TABLE `history_payment` DISABLE KEYS */;
/*!40000 ALTER TABLE `history_payment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `parkingcashflow`
--

DROP TABLE IF EXISTS `parkingcashflow`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `parkingcashflow` (
  `CASHFLOW_ID` varchar(255) NOT NULL,
  `AMOUNT` float DEFAULT NULL,
  `ENDDATE` date DEFAULT NULL,
  `INSTALLMENT_NUMBER` int(11) DEFAULT NULL,
  `STARTDATE` date DEFAULT NULL,
  `STATU` tinyint(1) DEFAULT '0',
  `CARPARKING_ID` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`CASHFLOW_ID`),
  KEY `FKrup4rml4ijf6wgycrxpruidff` (`CARPARKING_ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `parkingcashflow`
--

LOCK TABLES `parkingcashflow` WRITE;
/*!40000 ALTER TABLE `parkingcashflow` DISABLE KEYS */;
INSERT INTO `parkingcashflow` VALUES ('221db166-2b38-45a0-b0f2-27d344303726',35,'2017-09-07',1,'2017-08-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('1c8d2760-9470-48c3-b85a-74b13759d415',35,'2017-10-07',2,'2017-09-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('655c9a19-3a3f-4c5b-b5b0-b7addfb775bf',35,'2017-11-07',3,'2017-10-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('11dd23cb-d5c9-4f69-b1a3-a6db1308a567',35,'2017-12-07',4,'2017-11-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('babb00c3-4c1f-43cc-b0bd-304d179521ed',35,'2018-01-07',5,'2017-12-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('95925423-4a80-4cec-9738-7610bd52e2de',35,'2018-02-07',6,'2018-01-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('50719882-48cc-4e37-bdd7-ba9502365291',35,'2018-03-07',7,'2018-02-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('ab522581-2588-456f-a00c-9e62d4ba3177',35,'2018-04-07',8,'2018-03-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('14bd67a0-0bc1-454a-8d3e-f778c3ebd90b',35,'2018-05-07',9,'2018-04-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('8cbec15b-aa47-445e-8292-8ebcd782cf1b',35,'2018-06-07',10,'2018-05-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('43281787-99c2-4ec3-b63b-1c8a4932f73c',35,'2018-07-07',11,'2018-06-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('ebb5fd5e-7f2d-4a98-bbe2-c1c8732c83f6',35,'2018-08-07',12,'2018-07-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('70f22c58-d891-4ec8-bea3-f88f46be7528',35,'2018-09-07',13,'2018-08-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('e39d5877-3a1a-4453-926b-34ff4a9d8f4f',35,'2018-10-07',14,'2018-09-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('f55b3b30-6a0d-422f-b661-bd82afd6e0a7',35,'2018-11-07',15,'2018-10-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('62a5e5cc-6654-43a3-a1fe-2ed694a7b715',35,'2018-12-07',16,'2018-11-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('bf2b0d8e-aa1e-47cd-a94f-affbed158b4e',35,'2019-01-07',17,'2018-12-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('d226cd6f-7a9a-4c87-99c2-385211bf8a50',35,'2019-02-07',18,'2019-01-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('e253b8ac-1436-47cf-abce-ae70cbae713d',35,'2019-03-07',19,'2019-02-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('a748b139-262a-437b-8106-af3ddcefba4d',35,'2019-04-07',20,'2019-03-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('f09cef93-2df5-46ca-8dd7-2e353377eb08',35,'2019-05-07',21,'2019-04-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('612b832e-9cb1-4dfe-b152-c128f4adfa1d',35,'2019-06-07',22,'2019-05-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('16d460a6-d928-4ae2-9b8d-1bd50d74929b',35,'2019-07-07',23,'2019-06-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('8a81e781-ac01-40fe-9e42-2917c36b99d6',35,'2019-08-07',24,'2019-07-07',0,'270f8ed3-c09e-4358-b22b-246c7472069b'),('4955d30b-e1bd-4d43-880b-42c26d17c2a1',30,'2017-09-07',1,'2017-08-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('073b2a38-78b9-4439-81b9-fc0ae4b5d141',30,'2017-10-07',2,'2017-09-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('637b0bee-c25f-490c-b7d6-607a6ff75ed6',30,'2017-11-07',3,'2017-10-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('6bba6ca4-a625-4498-9a82-bcad8587475f',30,'2017-12-07',4,'2017-11-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('2ef9d5b3-ba43-4961-91e1-87c2c7cbafed',30,'2018-01-07',5,'2017-12-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('364a5af0-18ef-4c0b-916f-4a73d3178bee',30,'2018-02-07',6,'2018-01-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('ce2f36c8-9f5c-4c9f-8a79-71785b696f83',30,'2018-03-07',7,'2018-02-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('7fd430f9-2c3a-4be6-84d0-fb92aae9f22e',30,'2018-04-07',8,'2018-03-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('18cde052-844c-470a-9526-9bd4665ba548',30,'2018-05-07',9,'2018-04-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('60501a89-f92c-4bd6-9520-b3c62d88295b',30,'2018-06-07',10,'2018-05-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('d1d276fa-032d-4537-88cd-83df086d05bc',30,'2018-07-07',11,'2018-06-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('9466bbf1-0afe-4a18-8e0a-1e4683cf9027',30,'2018-08-07',12,'2018-07-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('c4a4e224-bfb1-4212-ad35-fbcf04eb5836',30,'2018-09-07',13,'2018-08-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('f1fa328c-a84c-4bb5-bafb-741e0ce821d1',30,'2018-10-07',14,'2018-09-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('1e534f87-ceaf-44cb-bf46-4b9a8cd2eb5f',30,'2018-11-07',15,'2018-10-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('0a488d9e-0ba3-4f2d-bd83-063a082eba0e',30,'2018-12-07',16,'2018-11-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('e731f4a8-d44a-429c-84e8-41e9d36f2953',30,'2019-01-07',17,'2018-12-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('7e9408f6-9449-4e41-b195-2ac4e43a7058',30,'2019-02-07',18,'2019-01-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('7117448a-d78a-4600-b44a-587a1e6e2d36',30,'2019-03-07',19,'2019-02-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('5def1e71-d94d-4d57-a7e2-5f2838acd1c9',30,'2019-04-07',20,'2019-03-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('347cb96f-6a77-40a1-9a85-a1a18329aedf',30,'2019-05-07',21,'2019-04-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('a4744494-2c44-4436-bc48-9f220832b497',30,'2019-06-07',22,'2019-05-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('465a15ad-57e3-42e4-a8ad-a77975b1ac08',30,'2019-07-07',23,'2019-06-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('a0f87bc1-f670-4e6c-b3de-85a0efb5c0f0',30,'2019-08-07',24,'2019-07-07',0,'615c9762-8916-4bd7-a23b-33ba70881e4c'),('90bda1ed-350a-4e91-85c3-3bebb1ada6eb',20,'2017-09-07',1,'2017-08-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('14913b1b-cda0-42ae-a74b-e730e598675c',20,'2017-10-07',2,'2017-09-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('965da050-38aa-4890-aa24-9b58f67898c7',20,'2017-11-07',3,'2017-10-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('3b6f56e6-7a9a-4dcb-af2e-94d0a2e7a715',20,'2017-12-07',4,'2017-11-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('304ca4a7-76bb-48b0-bf75-9ab84f79b5ee',20,'2018-01-07',5,'2017-12-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('b1c3f4dc-edbd-4a7a-b7ad-ee6003165323',20,'2018-02-07',6,'2018-01-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('609de2ae-68c6-4059-b10b-780f53161ecc',20,'2018-03-07',7,'2018-02-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('8aab1d8a-87f9-4b31-9be9-bca5e0705ce4',20,'2018-04-07',8,'2018-03-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('7be06b73-2d74-4485-97aa-4a51dcb9151c',20,'2018-05-07',9,'2018-04-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('f444d0b5-2a39-49a4-9175-a475d4cf6e1a',20,'2018-06-07',10,'2018-05-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('d34f70e2-a127-4453-bec4-3c638a2a25ef',20,'2018-07-07',11,'2018-06-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('45c2ae07-368b-4144-a4ed-7066d4242123',20,'2018-08-07',12,'2018-07-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('d5fd2d81-c4d1-4d23-bff2-e8d462441a85',20,'2018-09-07',13,'2018-08-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('24558d40-e235-4f9c-9fd9-1099fce85aad',20,'2018-10-07',14,'2018-09-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('33fa273e-025d-4934-9056-91ba6c378c42',20,'2018-11-07',15,'2018-10-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('dfaf2c5c-922d-4780-9c5e-43583bfd3eb0',20,'2018-12-07',16,'2018-11-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('1815513b-924e-4d31-a450-f0295476dcff',20,'2019-01-07',17,'2018-12-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('c83075c8-be51-4e2b-b8dd-f29d4c86a337',20,'2019-02-07',18,'2019-01-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('ffce4e44-caa8-4af6-9d10-3cf8af554f63',20,'2019-03-07',19,'2019-02-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('fedd72e6-8cc0-499d-aef6-53a8d6ff38c6',20,'2019-04-07',20,'2019-03-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('d28640d3-99e2-4a7f-871b-f74cd95559b2',20,'2019-05-07',21,'2019-04-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('aabded2a-d052-4be1-bcbc-b39cd8cc9869',20,'2019-06-07',22,'2019-05-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('155facf9-baf3-42e7-948a-872717cd8ad5',20,'2019-07-07',23,'2019-06-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('85c2b0aa-dde8-4268-a767-55dd54d4ffd0',20,'2019-08-07',24,'2019-07-07',0,'959d1d0d-1620-452d-ab8e-36790228c147'),('f73e030d-e741-43f8-a716-34b5e8801ccf',40,'2017-11-06',1,'2017-10-06',0,'73396480-ef7d-4dc2-be5c-84e01d30f7a6'),('05034bc3-c42b-42f6-bde5-8eaf2ce7b768',40,'2017-12-06',2,'2017-11-06',0,'73396480-ef7d-4dc2-be5c-84e01d30f7a6');
/*!40000 ALTER TABLE `parkingcashflow` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `payment` (
  ...
  KEY `FKhwvbbllupi6t51f78m7hc9kfq` (`USER_ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payment` VALUES ('4d151c76-d5ef-4d6e-b48c-b07d94030fa6',700,'Mark',2,1,202,'2017-08-09',NULL,NULL,NULL),('00c64af7-dcc1-4d5e-b778-8c14be8530ad',900,'Song',1,1,103,'2017-08-09',NULL,NULL,NULL),('462a30e5-83a1-4a63-8722-7f2a165f3389',800,'Lida',2,1,201,'2017-08-09',NULL,NULL,NULL),('e64838ba-e640-468a-848c-3a3ac66c3168',1200,'Fong',1,1,102,'2017-08-09',NULL,NULL,NULL),('1800626a-5c34-4aaf-ba25-e5cb98c9954c',1050,'Doms',4,1,401,'2017-08-11',NULL,NULL,NULL),('8cde165f-c9b5-41dd-acd6-af32126f84d8',950,'Hav',1,1,101,'2017-08-11',NULL,NULL,NULL),('4460e5a7-a0ac-4597-95a4-d238886e66cc',850,'Yina',2,1,203,'2017-08-11',NULL,NULL,NULL),('9f9bed11-33ee-4bf1-9f4e-7ae0e23af35e',1000,'Pov',1,1,104,'2017-08-11',NULL,NULL,NULL),('21a2e905-61b5-4df6-88b1-7b3a89d3d922',700,'Mark',2,2,202,'2017-08-11',NULL,NULL,NULL),('d476a530-ce91-4a24-b4f9-8c56074ae745',700,'Mark',2,3,202,'2017-08-11',NULL,NULL,NULL),('e352abaa-f9be-4ccf-af8d-956f1d9732ac',700,'Mark',2,4,202,'2017-08-11',NULL,NULL,NULL),('14b33efa-b883-4463-96a6-8f31cf8c4fae',700,'Mark',2,5,202,'2017-08-11',NULL,NULL,NULL),('8a747fb2-4b1b-45cb-92bd-bd422e29349a',700,'Mark',2,6,202,'2017-08-11',NULL,NULL,NULL),('c053a47e-9a71-4ff2-88c8-1d17aa483d42',700,'Mark',2,7,202,'2017-08-11',NULL,NULL,NULL);
...
INSERT INTO `users` VALUES ('670c2fad-9bae-46ac-9d49-3dff500d0b08','mongheng@mail.com','12345','081345671','mongheng','5fe942e6-7d77-48a0-bbf4-b7094cb1cf80',NULL),('27abfc1c-a909-4df7-b83f-e8c80559c9b2','sochenda@gmail.com','12345','012345678','sochenda','eb8cb55c-604f-4408-8bc7-c2d173586189',NULL),('4489d1e1-1b51-4dbe-9c6c-d2df827080ab','tian@gmail.com','12345','016345678','tian','5a2f0cab-240e-49e2-b41c-bdfa5b8248f6',NULL),('989d0da5-e7f8-479f-92a0-190365b1f719','sok@gmail.com','12345','015345678','sok','603d38c3-a902-45d0-a640-ceba6f1cfc88',NULL),('d500eb10-f01e-4a6c-afaf-03805cbed406','hellen@gmail.com','12345','092345678','hellen','c24266d6-28ee-4a3d-859a-2cb514c46115',NULL),('0f8369d5-1d80-47c7-8e63-6dbd2995ce54','san@gmail.com','12345','012713113','san','5a2f0cab-240e-49e2-b41c-bdfa5b8248f6',NULL),('41ba91a6-d67d-4f79-85d0-08a6e02dd9ae','jeff@gmail.com','12345','097345678','jeff','5fe942e6-7d77-48a0-bbf4-b7094cb1cf80',NULL);
...
-- Dump completed on 2017-10-06 13:50:59
